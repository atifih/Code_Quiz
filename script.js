...
function StartQuiz() {
  ...
  //  for (; questionsIndex < questionsArray.length; questionsIndex++) {
...
function getQuestion() {
    ...
    questionsContainerEl.appendChild(Question);
...
function optionClicked(btn) {
    ...
    if (questionsIndex < questionsArray.length) {
        ...
        if ((btn === "Option-1") && (questionsArray[questionsIndex].answerId === 0)) {
            console.log('correct')
            Score++;
            AnswersEl.innerHTML = "Correct"; // Advise the user of the result.
        }
            ...
            time -= 10;
            AnswersEl.innerHTML = "Incorrect";


        }
        questionsIndex++;
        getQuestion();
        document.body.appendChild(AnswersEl);  // Display result to the user.
...
function displayFinalScore(Score) {
    ...
    finalScoreEl.setAttribute("id", "finalScore");
    finalScoreEl.innerHTML = "Your final score was: " + Score;
